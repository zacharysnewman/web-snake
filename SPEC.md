...
| Milestone | Goal |
|---|---|
| **0 — CI/CD & GitHub Pages** | Configure GitHub Actions to build and deploy the Vite app to GitHub Pages on every push to `main`. Set the Vite `base` path to `/web-snake/` so assets resolve correctly under the Pages sub-path. |
